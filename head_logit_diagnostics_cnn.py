    ...
    for dataset in datasets:
        ...
        with open(config_file, "r") as f:
            for cfg_line in f:
                ...
                if do_enabled:
                    logger.info("DO enabled; removing MCD from confidence measures to avoid OOM.")
                    evals_test = cf.eval.confidence_measures.test
                    cf.eval.confidence_measures.test = [i for i in evals_test if "mcd" not in i]
