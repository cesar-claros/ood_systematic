...
```
{
 ...
 "validation": {
  "git_head_at_run": "2f2d643411e3da260b126f4e302a3b0e00246f8e",
  "checks": {
   ...
   "reader_v2_sha256": "87be5dc3b03c7e10ddb5da6761c4abdf85afba396a7f549510ad4fdd3054e775",
   ...
   "license_v2": {
    "path": "rn18_handoff_replication/simulations/qualification_report_v3.json",
    "version": 3,
    "sha256": "72ec890a494b491075f1ef3420334d4a99ab4988baa76d76b1464942a7b2eaad",
    "seed": 2406,
    "licensed": {
     "SEL_Nf10": 1.5,
     "SEL_Nf5": 2.0
    ...
    "scopes": {
     "SEL_Nf10": {
      ...
      "rule": "licensed for panels whose frozen-arm tie fraction is <= max_tie_fraction (amendment 2026-09-11)",
      "excluded_ladder_levels": [
       0.9
      ]
     },
     "SEL_Nf5": {
      "max_tie_fraction": 0.9,
      "rule": "licensed for panels whose frozen-arm tie fraction is <= max_tie_fraction (amendment 2026-09-11)",
      "excluded_ladder_levels": []
     }
    }
 ...
 "denominators": {
  ...
  "license_file": "rn18_handoff_replication/simulations/qualification_report_v3.json",
  "scope_applicability": {
   "SEL_Nf10": {
    "observed_tie_fraction": 0.0,
    "max_tie_fraction": 0.5,
    "within_scope": true
   },
   "SEL_Nf5": {
 ...
 "SEL_ce": {
  "evidence_class": "REGISTERED (alpha 0.025, Bonferroni 9)",
  "license": {
   "licensed": true,
   "multiplier": 1.5
  },
  ...
  "comparators": {
   "always_energy": {
    ...
    "ci": [
     -0.014440675210122196,
     0.027473175210122186
    ],
    "ci_display": [
     -0.01444,
     0.02747
   ...
   "vgg_kid_isotonic": {
    ...
    "ci": [
     -0.004985056881092711,
     0.010665056881092708
    ],
    "ci_display": [
     -0.00499,
     0.01067
   ...
   "vgg_source_shift_mean": {
    ...
    "ci": [
     -0.005590477107519271,
     0.011150477107519267
    ],
    "ci_display": [
     -0.00559,
     0.01115
   ...
   "vgg_geometry_severity_ridge": {
    ...
    "ci": [
     -0.0030397208195641037,
     0.002295970819564106
    ],
    "ci_display": [
     -0.00304,
     0.0023
   ...
   "vgg_no_target_batch_ridge": {
    ...
    "ci": [
     -0.002796555123226685,
     0.014277805123226683
    ],
    "ci_display": [
     -0.0028,
     0.01428
 ...
 "SEL_ce_augview_comparators_sensitivity": {
  ...
  "comparators": {
   ...
   "vgg_geometry_severity_ridge": {
    ...
    "ci": [
     -0.0034278659181358117,
     0.002935365918135812
    ],
    "ci_display": [
     -0.00343,
     0.00294
   ...
   "vgg_matched_scalar_ridge": {
    ...
    "ci": [
     -0.010713235638255493,
     0.007474485638255488
    ],
    "ci_display": [
     -0.01071,
     0.00747
